...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar bg-info">
    ...
    <!-- <script>document.addEventListener('DOMContentLoaded', fetchReviews);
     ...
     <!----------------------Online Reservation------------->
<h2 class="mt-5 text-center text-dark font-weight-bold font-italic" data-name="shree_ram_caters" >Shree Ram Caters</h2>
...
<form method="POST" onsubmit="return order()" action="info_data.php" id="reservationForm">
...
<script>
    ...
    //         // Optional: Add any additional JavaScript logic here
